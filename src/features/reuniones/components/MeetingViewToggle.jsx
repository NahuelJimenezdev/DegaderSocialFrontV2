      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div className="flex space-x-1.5 sm:space-x-2">
          <button
            ...
            className={`flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 rounded-lg font-medium transition-all duration-200 text-sm sm:text-base flex-1 sm:flex-initial active:scale-95 ${
              view === 'list'
        ...
        {view === 'calendar' && (
          <div className="flex items-center justify-between w-full sm:grid sm:grid-cols-3 sm:items-center">
            ...
            <div className="sm:col-start-1 sm:justify-self-start">
              <button
                onClick={handleToday}
                className="px-2.5 sm:px-3 py-1.5 sm:py-1 text-xs sm:text-sm text-green-600 font-bold hover:bg-blue-50 rounded-lg transition-colors active:scale-95"
              >
                Hoy
              </button>
            </div>
            ...
            <div className="flex items-center gap-1 sm:gap-2 sm:col-start-3 sm:justify-self-end">
              ...
              <button
                ...
                className="p-1.5 sm:p-1 hover:bg-gray-100 rounded-lg transition-colors active:scale-95"
              >
                <ChevronLeft className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600" />
              </button>

              {/* Mes y año - versión corta en mobile, completa en desktop */}
              <div className="min-w-[80px] sm:min-w-[140px] text-center text-sm sm:text-base font-bold text-blue-600">
