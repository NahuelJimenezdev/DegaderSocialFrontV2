            ...
            {achievements.map((achievement, index) => (
                <motion.div
                    ...
                    className={`p-5 rounded-3xl border transition-all ${achievement.unlocked
                        ...
                        : 'bg-gray-100 dark:bg-black/20 border-gray-200 dark:border-white/5 opacity-50 grayscale'
                        }`}
                >
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                            ...
                            <p className={`text-xs leading-relaxed font-medium ${achievement.unlocked ? 'text-gray-600 dark:text-white/40' : 'text-gray-500 dark:text-white/40'}`}>
