...
import { Image as ImageIcon, X, CornerDownRight } from 'lucide-react';
...
const CommentItem = ({ comment, onReply, level = 0 }) => {
    ...
    const handleSubmitReply = (e) => {
        ...
        if (replyContent.trim() || replyImage) {
            // Logic for flat vs nested replies:
            // If current comment has parent, use that parent. Else use current id.
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-4 mt-1 ml-2">
                    <button
                        ...
                        className="text-xs font-semibold text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 flex items-center gap-1"
                    >
